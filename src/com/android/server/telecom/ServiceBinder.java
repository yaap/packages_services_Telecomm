    ...
    final class Binder2 {
        ...
        void bind(BindCallback callback, Call call) {
            ...
            if (mServiceConnection == null) {
                ...
                int bindingFlags = Context.BIND_AUTO_CREATE | Context.BIND_FOREGROUND_SERVICE;
                if (!com.android.internal.telecom.flags.Flags.connectionServiceBal()) {
                    // Only permit background activity launches if flag is off.
                    bindingFlags |= Context.BIND_ALLOW_BACKGROUND_ACTIVITY_STARTS;
                }
