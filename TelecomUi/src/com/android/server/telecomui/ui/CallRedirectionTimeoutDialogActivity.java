...
public class CallRedirectionTimeoutDialogActivity extends Activity {
    private static final String TAG = CallRedirectionTimeoutDialogActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "CallRedirectionTimeoutDialogActivity onCreate.");
    ...
    private void showDialog(final CharSequence redirectionAppName) {
        Log.i(TAG, String.format("showDialog: timeout redirection with %s", redirectionAppName));
